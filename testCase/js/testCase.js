...
//                $eventObj.currentTarget.css( "transform", "scale( 1, 1 )" );
        ...
        function addHierarchy(){
            ...
            box0.ev( "click", boxClick );
//            box1.ev( "click", boxClick );
            box2.ev( "click", boxClick );
            box0.ev( "mouseover", boxOver );
            box1.ev( "mouseover", boxOver );
